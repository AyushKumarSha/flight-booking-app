...
public class LoggingAspect {
    ...
    // Apply to all methods in controller, service packages
    @Pointcut("execution(* com.flightbooking.userservicewrite.controller..*(..)) || " +
              "execution(* com.flightbooking.userservicewrite.service..*(..))")
